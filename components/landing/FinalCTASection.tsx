...
const FinalCTASection: React.FC<FinalCTASectionProps> = ({
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl bg-slate-900 px-8 py-12 text-white lg:px-14 lg:py-16">
      ...
      <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="max-w-xl space-y-4">
          ...
          <p className="text-sm sm:text-base text-slate-200">
            On discute de ton idée, je te donne un plan clair : fonctionnalités,
            délai et budget. Aucun engagement, juste un échange honnête.
          </p>
        </div>
